...
?>
<?php
if ($heading || $category_heading || $categories || $search_input_placeholder || $video_list || $pages || $previous_arrow || $next_arrow) {
?>
  ...
  <section class="video-catalog mt-20 mb-14">
    <div class="wrapper">
      ...
      <?php } ?>
      <?php if ($category_heading || $categories || $search_input_placeholder) { ?>
        <div class="filter flex justify-between items-center">
          <?php if ($category_heading || $categories) { ?>
          ...
          <?php } ?>
          <?php if ($search_input_placeholder) { ?>
      ...
      <?php } ?>
      <?php if ($pages || $previous_arrow || $next_arrow) { ?>
        <?php if ($previous_arrow) { ?>
